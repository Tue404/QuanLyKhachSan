...
namespace QuanLyKhachSan {
    ...
    public partial class QuanLyKhachSanDataSet : global::System.Data.DataSet {
        ...
        public partial class NhanVienDataTable : global::System.Data.TypedTableBase<NhanVienRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public NhanVienRow AddNhanVienRow(string MaNhanVien, string TenNhanVien, string GioiTinh, string DiaChi, string SoDienThoai, System.DateTime NgaySinh, System.DateTime NgayVaoLam, string ChucVu, string CCCD) {
...
namespace QuanLyKhachSan.QuanLyKhachSanDataSetTableAdapters {
    ...
    public partial class NhanVienTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[NhanVien] ([MaNhanVien], [TenNhanVien], [GioiTinh], [DiaChi], [SoDienThoai], [NgaySinh], [NgayVaoLam], [ChucVu], [CCCD]) VALUES (@MaNhanVien, @TenNhanVien, @GioiTinh, @DiaChi, @SoDienThoai, @NgaySinh, @NgayVaoLam, @ChucVu, @CCCD);
SELECT MaNhanVien, TenNhanVien, GioiTinh, DiaChi, SoDienThoai, NgaySinh, NgayVaoLam, ChucVu, CCCD FROM NhanVien WHERE (MaNhanVien = @MaNhanVien)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[NhanVien] SET [MaNhanVien] = @MaNhanVien, [TenNhanVien] = @TenNhanVien, [GioiTinh] = @GioiTinh, [DiaChi] = @DiaChi, [SoDienThoai] = @SoDienThoai, [NgaySinh] = @NgaySinh, [NgayVaoLam] = @NgayVaoLam, [ChucVu] = @ChucVu, [CCCD] = @CCCD WHERE (([MaNhanVien] = @Original_MaNhanVien) AND ((@IsNull_TenNhanVien = 1 AND [TenNhanVien] IS NULL) OR ([TenNhanVien] = @Original_TenNhanVien)) AND ((@IsNull_GioiTinh = 1 AND [GioiTinh] IS NULL) OR ([GioiTinh] = @Original_GioiTinh)) AND ((@IsNull_DiaChi = 1 AND [DiaChi] IS NULL) OR ([DiaChi] = @Original_DiaChi)) AND ((@IsNull_SoDienThoai = 1 AND [SoDienThoai] IS NULL) OR ([SoDienThoai] = @Original_SoDienThoai)) AND ((@IsNull_NgaySinh = 1 AND [NgaySinh] IS NULL) OR ([NgaySinh] = @Original_NgaySinh)) AND ((@IsNull_NgayVaoLam = 1 AND [NgayVaoLam] IS NULL) OR ([NgayVaoLam] = @Original_NgayVaoLam)) AND ((@IsNull_ChucVu = 1 AND [ChucVu] IS NULL) OR ([ChucVu] = @Original_ChucVu)) AND ((@IsNull_CCCD = 1 AND [CCCD] IS NULL) OR ([CCCD] = @Original_CCCD)));
SELECT MaNhanVien, TenNhanVien, GioiTinh, DiaChi, SoDienThoai, NgaySinh, NgayVaoLam, ChucVu, CCCD FROM NhanVien WHERE (MaNhanVien = @MaNhanVien)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT MaNhanVien, TenNhanVien, GioiTinh, DiaChi, SoDienThoai, NgaySinh, NgayVaoL" +
                "am, ChucVu, CCCD FROM dbo.NhanVien";
        ...
        public virtual int Insert(string MaNhanVien, string TenNhanVien, string GioiTinh, string DiaChi, string SoDienThoai, global::System.Nullable<global::System.DateTime> NgaySinh, global::System.Nullable<global::System.DateTime> NgayVaoLam, string ChucVu, string CCCD) {
            if ((MaNhanVien == null)) {
        ...
        public virtual int Update(
                    ...
                    string Original_ChucVu, 
                    string Original_CCCD) {
            return this.Update(Original_MaNhanVien, TenNhanVien, GioiTinh, DiaChi, SoDienThoai, NgaySinh, NgayVaoLam, ChucVu, CCCD, Original_MaNhanVien, Original_TenNhanVien, Original_GioiTinh, Original_DiaChi, Original_SoDienThoai, Original_NgaySinh, Original_NgayVaoLam, Original_ChucVu, Original_CCCD);
        }
    }
